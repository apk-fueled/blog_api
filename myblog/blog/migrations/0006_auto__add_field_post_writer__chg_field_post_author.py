...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.writer'
        db.add_column(u'blog_post', 'writer',
    ...
    def backwards(self, orm):
        # Deleting field 'Post.writer'
        db.delete_column(u'blog_post', 'writer_id')
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'writer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blog.Post']", 'null': 'True', 'blank': 'True'})
        },
        u'blog.tag': {
