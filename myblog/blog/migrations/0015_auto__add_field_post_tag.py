...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_post', 'tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Tag'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.tag'
        db.delete_column(u'blog_post', 'tag_id')
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blog.Tag']", 'null': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {}),
