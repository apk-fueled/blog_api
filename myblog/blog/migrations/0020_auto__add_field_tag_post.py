...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_tag', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Post'], null=True),
                      keep_default=False)

        # Removing M2M table for field post on 'Tag'
        db.delete_table(db.shorten_name(u'blog_tag_post'))
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'blog_tag_post')
    ...
    models = {
        ...
        u'blog.tag': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blog.Post']", 'null': 'True'}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '20', 'primary_key': 'True'})
        },
